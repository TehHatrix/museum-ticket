...
//                    break;
//                }
                // if there are visitor in queue remove the first one and add to hashmap
                if (getVisitorQueue().peek() != null) {
                    ...
                    // add the ticket holder to the hashmap
